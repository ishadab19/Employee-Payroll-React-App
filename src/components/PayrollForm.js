        ...
        <div>
            ...
            <div className="form-content">
                    ...
                    <div className="row-content">
                        ...
                        <div className="profile-radio-content">
                            <label>
                                ...
                                <img className="profile" id="image1" src={Pic1} alt="profile" />
                            </label>
                            <label>
                                <input type="radio" id="profile2" name="profile" value="/assets/profile-images/pic2.png" required />
                                <img className="profile" id="image2" src={Pic2} alt="profile" />
                            </label>
                            <label>
                                <input type="radio" id="profile1" name="profile" value="/assets/profile-images/pic1.png" required></input>
                                <img className="profile" id="image1" src={Pic3} alt="profile" />
                            </label>
                            <label>
                                <input type="radio" id="profile2" name="profile" value="/assets/profile-images/pic2.png" required />
                                <img className="profile" id="image2" src={Pic4} alt="profile" />
                            </label>
                        </div>
                    </div>
                    <div className="row-content">
              ...
              <input className="input" type="range" name="salary" id="salary" 
                     min="300000" max="500000" step="1000 "></input>
